...
EXPORT meas_image_ba81_to_rgb3(unsigned char *ba81, unsigned char *rgb3, int width, int height) {
  ...
  for (i = ii = 0; i < height/4; i += 1, ii += 2) /* vertical */
    for (j = jj = 0; j < w4; j += 1, jj += 2) {   /* horzontal */
      ...
      rgb3[ii * 3 * w2 + 3 * jj + 2] = ba81[i * 16 * w4 + 16 * j]; /* B00 */

      /* 1 */
      rgb3[ii * 3 * w2 + 3 * (jj+1)    ] = ba81[i * 16 * w4 + 16 * j + 7]; /* R13 */
      rgb3[ii * 3 * w2 + 3 * (jj+1) + 1] = (ba81[i * 16 * w4 + 16 * j + 3] + ba81[i * 16 * w4 + 16 * j + 6]) / 2;   /* average of G03 and G12 */
      rgb3[ii * 3 * w2 + 3 * (jj+1) + 2] = ba81[i * 16 * w4 + 16 * j + 2]; /* B02 */
      ...
      rgb3[(ii+1) * 3 * w2 + 3 * (jj+1) + 1] = (ba81[i * 16 * w4 + 16 * j + 11] + ba81[i * 16 * w4 + 16 * j + 14]) / 2;   /* average of G23 and G32 */
      rgb3[(ii+1) * 3 * w2 + 3 * (jj+1) + 2] = ba81[i * 16 * w4 + 16 * j + 10]; /* B22 */
    }
}
