...
EXPORT meas_image_ba81_to_rgb3(unsigned char *ba81, unsigned char *rgb3, int width, int height) {
  ...
  for (i = ii = 0; i < height/2; i += 1, ii += 2)
    for (j = jj = 0; j < width/2; j += 1, jj += 2) {
      /* 0 */
      rgb3[ii * 3 * w2 + 3 * jj    ] = ba81[i * 12 * w4 + 12 * j + 5]; /* R11 */
      rgb3[ii * 3 * w2 + 3 * jj + 1] = (ba81[i * 12 * w4 + 12 * j + 1] + ba81[i * 12 * w4 + 12 * j + 4]) / 2;   /* average of G01 and G10 */
      rgb3[ii * 3 * w2 + 3 * jj + 2] = ba81[i * 12 * w4 + 12 * j + 0]; /* B00 */

      /* 1 */
      rgb3[ii * 3 * w2 + 3 * (jj+1)    ] = ba81[i * 12 * w4 + 12 * j + 7]; /* R13 */
      rgb3[ii * 3 * w2 + 3 * (jj+1) + 1] = (ba81[i * 12 * w4 + 12 * j + 3] + ba81[i * 12 * w4 + 12 * j + 6]) / 2;   /* average of G03 and G12 */
      rgb3[ii * 3 * w2 + 3 * (jj+1) + 2] = ba81[i * 12 * w4 + 12 * j + 2]; /* B02 */

      /* 2 */
      rgb3[(ii+1) * 3 * w2 + 3 * jj    ] = ba81[i * 12 * w4 + 12 * j + 13]; /* R31 */
      rgb3[(ii+1) * 3 * w2 + 3 * jj + 1] = (ba81[i * 12 * w4 + 12 * j + 9] + ba81[i * 12 * w4 + 12 * j + 12]) / 2;   /* average of G21 and G30 */
      rgb3[(ii+1) * 3 * w2 + 3 * jj + 2] = ba81[i * 12 * w4 + 12 * j + 8]; /* B30 */

      /* 3 */
      rgb3[(ii+1) * 3 * w2 + 3 * (jj+1)    ] = ba81[i * 12 * w4 + 12 * j + 15]; /* R33 */
      rgb3[(ii+1) * 3 * w2 + 3 * (jj+1) + 1] = (ba81[i * 12 * w4 + 12 * j + 11] + ba81[i * 12 * w4 + 12 * j + 14]) / 2;   /* average of G23 and G32 */
      rgb3[(ii+1) * 3 * w2 + 3 * (jj+1) + 2] = ba81[i * 12 * w4 + 12 * j + 10]; /* B22 */
    }
}
